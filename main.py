...
if __name__ == "__main__":
    ...
    print("мин ограничение по цене (по умолчанию 0)")
    minPrice = input()
    print("макс ограничение по цене (по умолчанию 1000)")
    maxPrice = input()
    ...
    try:
        YoulaParser(url=urlYoula, version_main=110,  # 124 or 110
                    price=int(maxPrice), data_list_count=int(data_list_count)).parse()
    except Exception as e:
